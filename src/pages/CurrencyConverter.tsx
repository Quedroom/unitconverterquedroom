...
const currencies: Currency[] = [
  ...
  { code: "INR", name: "Indian Rupee", symbol: "₹", flag: "🇮🇳", rateToUSD: 83.12 },
  { code: "JPY", name: "Japanese Yen", symbol: "¥", flag: "🇯🇵", rateToUSD: 149.50 },
  ...
  { code: "CHF", name: "Swiss Franc", symbol: "Fr", flag: "🇨🇭", rateToUSD: 0.88 },
  { code: "HKD", name: "Hong Kong Dollar", symbol: "HK$", flag: "🇭🇰", rateToUSD: 7.82 },
  { code: "SGD", name: "Singapore Dollar", symbol: "S$", flag: "🇸🇬", rateToUSD: 1.34 },
  { code: "SEK", name: "Swedish Krona", symbol: "kr", flag: "🇸🇪", rateToUSD: 10.42 },
  { code: "KRW", name: "South Korean Won", symbol: "₩", flag: "🇰🇷", rateToUSD: 1320.50 },
  { code: "MXN", name: "Mexican Peso", symbol: "$", flag: "🇲🇽", rateToUSD: 17.15 },
  { code: "NZD", name: "New Zealand Dollar", symbol: "NZ$", flag: "🇳🇿", rateToUSD: 1.64 },
  { code: "BRL", name: "Brazilian Real", symbol: "R$", flag: "🇧🇷", rateToUSD: 4.97 },
  { code: "ZAR", name: "South African Rand", symbol: "R", flag: "🇿🇦", rateToUSD: 18.65 },
  { code: "RUB", name: "Russian Ruble", symbol: "₽", flag: "🇷🇺", rateToUSD: 92.50 },
  { code: "AED", name: "UAE Dirham", symbol: "د.إ", flag: "🇦🇪", rateToUSD: 3.67 },
  { code: "SAR", name: "Saudi Riyal", symbol: "﷼", flag: "🇸🇦", rateToUSD: 3.75 },
  { code: "THB", name: "Thai Baht", symbol: "฿", flag: "🇹🇭", rateToUSD: 35.20 },
  { code: "MYR", name: "Malaysian Ringgit", symbol: "RM", flag: "🇲🇾", rateToUSD: 4.72 },
  { code: "IDR", name: "Indonesian Rupiah", symbol: "Rp", flag: "🇮🇩", rateToUSD: 15750 },
  { code: "PHP", name: "Philippine Peso", symbol: "₱", flag: "🇵🇭", rateToUSD: 56.20 },
  { code: "PLN", name: "Polish Zloty", symbol: "zł", flag: "🇵🇱", rateToUSD: 4.02 },
  { code: "TRY", name: "Turkish Lira", symbol: "₺", flag: "🇹🇷", rateToUSD: 32.10 },
  { code: "NOK", name: "Norwegian Krone", symbol: "kr", flag: "🇳🇴", rateToUSD: 10.65 },
  { code: "DKK", name: "Danish Krone", symbol: "kr", flag: "🇩🇰", rateToUSD: 6.87 },
  { code: "PKR", name: "Pakistani Rupee", symbol: "₨", flag: "🇵🇰", rateToUSD: 278.50 },
  { code: "BDT", name: "Bangladeshi Taka", symbol: "৳", flag: "🇧🇩", rateToUSD: 109.75 },
  { code: "VND", name: "Vietnamese Dong", symbol: "₫", flag: "🇻🇳", rateToUSD: 24500 },
  { code: "EGP", name: "Egyptian Pound", symbol: "E£", flag: "🇪🇬", rateToUSD: 30.90 },
  { code: "NGN", name: "Nigerian Naira", symbol: "₦", flag: "🇳🇬", rateToUSD: 1550 },
  { code: "COP", name: "Colombian Peso", symbol: "$", flag: "🇨🇴", rateToUSD: 3950 },
  { code: "ARS", name: "Argentine Peso", symbol: "$", flag: "🇦🇷", rateToUSD: 875 },
  { code: "CLP", name: "Chilean Peso", symbol: "$", flag: "🇨🇱", rateToUSD: 940 },
  { code: "ILS", name: "Israeli Shekel", symbol: "₪", flag: "🇮🇱", rateToUSD: 3.65 },
  { code: "CZK", name: "Czech Koruna", symbol: "Kč", flag: "🇨🇿", rateToUSD: 23.20 },
  { code: "HUF", name: "Hungarian Forint", symbol: "Ft", flag: "🇭🇺", rateToUSD: 358 },
  { code: "RON", name: "Romanian Leu", symbol: "lei", flag: "🇷🇴", rateToUSD: 4.58 },
];
