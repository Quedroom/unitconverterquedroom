...
// Exchange rates as of February 2025 - Updated for accuracy
const currencies: Currency[] = [
  ...
  { code: "CAD", name: "Canadian Dollar", symbol: "C$", flag: "🇨🇦", rateToUSD: 1.44 },
  { code: "CHF", name: "Swiss Franc", symbol: "Fr", flag: "🇨🇭", rateToUSD: 0.90 },
  { code: "HKD", name: "Hong Kong Dollar", symbol: "HK$", flag: "🇭🇰", rateToUSD: 7.78 },
  { code: "SGD", name: "Singapore Dollar", symbol: "S$", flag: "🇸🇬", rateToUSD: 1.36 },
  { code: "SEK", name: "Swedish Krona", symbol: "kr", flag: "🇸🇪", rateToUSD: 10.95 },
  { code: "KRW", name: "South Korean Won", symbol: "₩", flag: "🇰🇷", rateToUSD: 1455 },
  { code: "MXN", name: "Mexican Peso", symbol: "$", flag: "🇲🇽", rateToUSD: 20.45 },
  { code: "NZD", name: "New Zealand Dollar", symbol: "NZ$", flag: "🇳🇿", rateToUSD: 1.78 },
  { code: "BRL", name: "Brazilian Real", symbol: "R$", flag: "🇧🇷", rateToUSD: 5.85 },
  { code: "ZAR", name: "South African Rand", symbol: "R", flag: "🇿🇦", rateToUSD: 18.35 },
  { code: "RUB", name: "Russian Ruble", symbol: "₽", flag: "🇷🇺", rateToUSD: 97.50 },
  { code: "AED", name: "UAE Dirham", symbol: "د.إ", flag: "🇦🇪", rateToUSD: 3.67 },
  { code: "SAR", name: "Saudi Riyal", symbol: "﷼", flag: "🇸🇦", rateToUSD: 3.75 },
  { code: "THB", name: "Thai Baht", symbol: "฿", flag: "🇹🇭", rateToUSD: 33.85 },
  { code: "MYR", name: "Malaysian Ringgit", symbol: "RM", flag: "🇲🇾", rateToUSD: 4.45 },
  { code: "IDR", name: "Indonesian Rupiah", symbol: "Rp", flag: "🇮🇩", rateToUSD: 16350 },
  { code: "PHP", name: "Philippine Peso", symbol: "₱", flag: "🇵🇭", rateToUSD: 58.20 },
  { code: "PLN", name: "Polish Zloty", symbol: "zł", flag: "🇵🇱", rateToUSD: 4.05 },
  { code: "TRY", name: "Turkish Lira", symbol: "₺", flag: "🇹🇷", rateToUSD: 35.80 },
  { code: "NOK", name: "Norwegian Krone", symbol: "kr", flag: "🇳🇴", rateToUSD: 11.25 },
  { code: "DKK", name: "Danish Krone", symbol: "kr", flag: "🇩🇰", rateToUSD: 7.15 },
  { code: "PKR", name: "Pakistani Rupee", symbol: "₨", flag: "🇵🇰", rateToUSD: 279.50 },
  { code: "BDT", name: "Bangladeshi Taka", symbol: "৳", flag: "🇧🇩", rateToUSD: 121.50 },
  { code: "VND", name: "Vietnamese Dong", symbol: "₫", flag: "🇻🇳", rateToUSD: 25350 },
  { code: "EGP", name: "Egyptian Pound", symbol: "E£", flag: "🇪🇬", rateToUSD: 50.85 },
  { code: "NGN", name: "Nigerian Naira", symbol: "₦", flag: "🇳🇬", rateToUSD: 1545 },
  { code: "COP", name: "Colombian Peso", symbol: "$", flag: "🇨🇴", rateToUSD: 4285 },
  { code: "ARS", name: "Argentine Peso", symbol: "$", flag: "🇦🇷", rateToUSD: 1055 },
  { code: "CLP", name: "Chilean Peso", symbol: "$", flag: "🇨🇱", rateToUSD: 985 },
  { code: "ILS", name: "Israeli Shekel", symbol: "₪", flag: "🇮🇱", rateToUSD: 3.62 },
  { code: "CZK", name: "Czech Koruna", symbol: "Kč", flag: "🇨🇿", rateToUSD: 24.15 },
  { code: "HUF", name: "Hungarian Forint", symbol: "Ft", flag: "🇭🇺", rateToUSD: 392 },
  { code: "RON", name: "Romanian Leu", symbol: "lei", flag: "🇷🇴", rateToUSD: 4.78 },
];
